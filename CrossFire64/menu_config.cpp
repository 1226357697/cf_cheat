...
static void loadESPConfig(IniFile& ini)
{
	...
	MenuConfig.ShowPlayerHP = (MenuConfig_::ShowHPWay)ini.readInt(xorstr_("ESP"), xorstr_("ShowPlayerHP"), MenuConfig.ShowPlayerHP);
...
static void loadAimBotConfig(IniFile& ini)
{
	...
	MenuConfig.AimType = (MenuConfig_::AimBotType)ini.readInt(xorstr_("AimBot"), xorstr_("AimType"), MenuConfig.AimType);
	MenuConfig.AimBotHotKey = ini.readInt(xorstr_("AimBot"), xorstr_("AimBotHotKey"), MenuConfig.AimBotHotKey);
	MenuConfig.AimPosition = (MenuConfig_::AimBotPos)ini.readInt(xorstr_("AimBot"), xorstr_("AimPosition"), MenuConfig.AimPosition);
	...
	MenuConfig.AimPolicy = (MenuConfig_::AimBotPolicy)ini.readInt(xorstr_("AimBot"), xorstr_("AimPolicy"), MenuConfig.AimPolicy);
